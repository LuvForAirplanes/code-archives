...
namespace SendFileTcpTest
{
    class Program
    {
        ...
        public static void FTServerCode()
        {
            System.Net.IPAddress ipaddress = System.Net.IPAddress.Parse("192.168.1.2");
            ipEnd = new IPEndPoint(ipaddress, 5656);
